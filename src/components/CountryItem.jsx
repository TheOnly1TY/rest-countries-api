...
export function CountryItem({ countryData }) {
  const { name, capital, region, population, flag, alpha3Code } = countryData;
  ...
  return (
    <li>
      <Link
        to={`${alpha3Code}`}
        className="w-[264px] md:w-full h-[336px] bg-white font-display shadow-[0_0_7px_2px_rgba(0,0,0,0.0294)] rounded-[5px]"
      >
        <img
          src={flag}
