...
export function FilterRegion() {
  ...
  return (
    <select
      ...
      className="bg-white dark:bg-[#2B3844] dark:text-white w-[200px] h-14 rounded-[5px] text-[12px] md:text-sm leading-5 font-display shadow-[0_2px_9px_0_rgba(0,0,0,0.0532)] mt-10 md:mt-0 px-6 outline-0"
